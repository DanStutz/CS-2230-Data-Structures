        ...
        if (this.sandHeight < this.HEIGHT) {
            if (this.getVolume() <= other.getVolume()) {    
                if (this.sandHeight == 0) {
                    ...
                    other.sandHeight = (other.getSandVolume() - this.getVolume()) / (other.getWidth() * other.getLength());
                }
                else {
                    double sandDiff = this.getSandVolume();
                    this.sandHeight = this.HEIGHT;
                    other.sandHeight = (other.getSandVolume() - (this.getSandVolume() - sandDiff)) / (other.getWidth() * other.getLength());
                }
            }
            else {
                this.sandHeight = other.getSandVolume() / (this.getWidth() * this.getLength());
                other.sandHeight = 0;
            }
        }
